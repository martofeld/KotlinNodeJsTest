...
tasks.withType<DukatTask>().configureEach {
    this.qualifiedPackageName = "com.mfeldsztejn"
}
...
val removeKtxNodejsFiles = tasks.create("removeKtxNodejsFiles").apply {
    doFirst {
        ...
        File(project.buildDir, "externals/${project.name}/src").listFiles()?.forEach {
...
/*
index.QueryString.module_qs.kt
